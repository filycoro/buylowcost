...
@Component({
  selector: 'app-truking-page',
  templateUrl: './truking-page.component.html',
  styleUrls: ['./truking-page.component.scss']
})
export class TrukingPageComponent implements OnInit {
  QuoteForm: FormGroup;
  submitted = false;
  data = {
    business_name: "",
